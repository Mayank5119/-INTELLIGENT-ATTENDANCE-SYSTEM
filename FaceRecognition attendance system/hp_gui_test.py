...
def main():
    ...
    while 1:
        ...
        layout = [
            ...
            [sg.Image(filename='', key='-IMAGE-',size=(60,50))],
            [sg.Text("SID here :" + str(label), key='-SID-'), sg.Text("Name:" + str(predicted_name), key='-NAME-'),
             sg.Text("Attendance Status :" + "P", key='-status-')],
            ...
            [sg.Text("Your temperature :" + str("Normal"), key='-your_temp-')],
