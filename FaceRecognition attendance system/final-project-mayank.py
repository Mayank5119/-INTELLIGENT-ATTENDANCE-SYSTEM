...
while 1:
    ...
    faces_detected = fr.FaceAligner(img)
    ...
    label, surity = face_recognizer.predict(faces_detected)  # predicting the label of given image
    # fr.draw_rect(test_img, face)
    # print(label, ":", surity)
    predicted_name = name.item()[label]
    present.append(label)

    print(label, ":", predicted_name, ":", surity)
